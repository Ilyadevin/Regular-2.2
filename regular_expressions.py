...
class RegularExpr:
    ...
    def regexing(self):
        ...
        for text in self.contacts_list:  # list with all stings from original file!!!
            ...
            while len(
                    employer_fio) < 3:  # if fields lastname, surname and firstname < then 3 then we put the mark '-'
                # in there
                employer_fio.append('-')
...
regexed_now = RegularExpr()
regexed_now.regexing()
regexed_now.write_in_file()
